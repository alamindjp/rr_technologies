...
const ServiceOffer = () => {
  return (
    <div className="bg-[#EBF0FF] relative py-20 w-11/12 lg:w-10/12 mx-auto">
      <div className="w-2 h-2 rounded-full bg-gradient-to-r from-[#2478FE] to-[#5380EA] absolute top-10 left-1/3 bottom-44 z-0"></div>
      <div className="w-5 h-5 rounded-full bg-gradient-to-r from-[#E54A2A] to-[#D91C5E] absolute left-10 md:left-36 bottom-36 md:bottom-12 z-0"></div>
      <div className="w-4 h-4 rounded-full bg-gradient-to-r from-[#14E45B] to-[#14C03A] absolute bottom-16 right-10 md:right-40 z-0"></div>
